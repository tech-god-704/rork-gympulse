...
import { Layout, Radius, Space, Type, elevation, glow, numeric, statNumber, tint } from "@/constants/theme";
...
const createStyles = (colors: ColorScheme) => StyleSheet.create({
  ...
  presetPillActive: {
    backgroundColor: tint(colors.primary, colors.scheme === "dark" ? 0.2 : 0.11),
